...
Usage:
  python3 _tools/convert_toys.py
  python3 _tools/convert_toys.py --target-faces 50000
  python3 _tools/convert_toys.py --skip-existing
...
SOURCE_DIR    = ROOT / "not-used" / "source-material" / "toys-source"
